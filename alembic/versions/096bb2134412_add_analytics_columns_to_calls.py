...
def upgrade():
    op.add_column('calls', sa.Column('embedding', postgresql.ARRAY(sa.Float), nullable=True))
    op.add_column('calls', sa.Column('agent_talk_ratio', sa.Float, nullable=True))
    op.add_column('calls', sa.Column('customer_sentiment_score', sa.Float, nullable=True))
